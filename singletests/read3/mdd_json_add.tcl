# Will create $fname.mdd.json file where fname = design name as in "128b1"
# Designed to be used for designs previously created to get a .json file.
proc mddMake {} {
    set props [list \
    ...
    set fname [lindex [split [pwd] /] end]
